...
- **Prospect Management**: Features a drag-and-drop Kanban board, user-specific data isolation, editable priority and referral source tracking, and confirmation-dialog-protected deletion. It also includes color-coded pipeline cards, PDF report generation with dynamic section numbering, AI-powered Business Overview section using web search, Use of Funds Breakdown allocation tool, and Excel export with grouped stages and detailed prospect data.
