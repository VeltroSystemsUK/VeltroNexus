  ...
  return (
    <div className="min-h-screen bg-background pb-24">
      ...
      <div className="container max-w-4xl mx-auto p-6 space-y-6">
        <Accordion type="single" collapsible className="w-full space-y-4" defaultValue="integrations">
          ...
          <AccordionItem value="item-2">
            <AccordionTrigger>CRM Configuration</AccordionTrigger>
            <AccordionContent className="space-y-6 pt-4">
          ...
          <AccordionItem value="item-3">
            <AccordionTrigger>Report Configuration</AccordionTrigger>
            <AccordionContent className="space-y-6 pt-4">
          ...
          <AccordionItem value="item-4">
            <AccordionTrigger>Data & Integrations</AccordionTrigger>
            <AccordionContent className="space-y-6 pt-4">
