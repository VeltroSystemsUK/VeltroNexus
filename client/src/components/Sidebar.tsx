...
const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { path: "/agent-mail", label: "Agent mail", icon: Mail, roles: ["super_admin", "sales_admin"] },
  ...
  },
  {
    ...
    items: [
      ...
      { path: "/openers", label: "Openers", icon: MailOpen, roles: ["super_admin", "sales_admin"] },
      { path: "/unsubscribed", label: "Unsubscribed", icon: Ban, roles: ["super_admin", "sales_admin"] },
      { path: "/non-responsive", label: "Non Responsive", icon: MailX, roles: ["super_admin", "sales_admin"] },
