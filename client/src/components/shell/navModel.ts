...
export const DESTINATIONS: Destination[] = [
  ...
  { path: "/agent-mail", label: "Agent mail", icon: Mail, group: "Sales", roles: ["super_admin", "sales_admin"], keywords: "email inbox agents monitor opened", description: "Monitor agent inbound and outbound email" },
