...
export function UnifiedHeader() {
    ...
    return (
        <header className="sticky top-0 z-40 w-full border-b border-border bg-background shadow-sm transition-all h-auto pb-[20px]">
            <div className="container flex items-center justify-between px-4 md:px-6 h-full">
                <div className="flex flex-col justify-center overflow-hidden min-h-[3rem] pt-[36px]">
                    ...
                    <div className="relative">
                        <h1
                            key={displayTitle}
                            className={cn(
                                "text-2xl md:text-3xl lg:text-4xl font-extrabold tracking-tight uppercase whitespace-nowrap text-foreground",
                        ...
                        {displayDesc && (
                            <p
                                ...
                                className={cn(
                                    "text-xs md:text-sm text-muted-foreground font-medium animate-in slide-in-from-left-3 fade-in duration-700 ease-out delay-100 fill-mode-both mt-0.5"
                                )}
                            >
                                {displayDesc}
                            </p>
                ...
                <div className="flex items-center">
                    ...
                    <div className="flex items-center gap-2 md:gap-4 pl-6 border-l border-border">
                        <ThemeToggle />
