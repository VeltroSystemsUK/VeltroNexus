...
import { STRATA_SOCIAL_PROMPT } from "@shared/strataSocial";
...
const CORE_WORKFORCE: DigitalAssociate[] = [
  ...
  },
  {
    ...
    scores: [
      ...
      { subject: "Lead-gen conversion design", A: 92, fullMark: 100 },
    ],
    voiceEnabled: false,
    aresCertification: { status: "certified", score: 96 },
    workflow: {
      ...
      responsibilities: [
        ...
        "Design the lead-generation machine: landing pages, lead magnets, calculators, email sequences",
        "Run campaign architecture end to end and the quarterly brand consistency review",
        "Own Strata Learn's information architecture, page templates, and per-page capture",
        "Set the visual and tonal standard SOCIAL-1 works to; review its templates quarterly",
        "Translate Casey Wren's Creative Ammo Briefs into hook, body, CTA, hashtags and links inside Craft limits",
        "Hang a Kit still, a stock pick, or a Grok still from Casey's prompt — never a grey box",
      ...
      tasks: [
        {
          ...
          steps: [
            ...
            "Find the human truth and pick three routes, one recommended, per track",
            "Pair each draft with a Kit, Grok, or stock still and brand-governed art direction",
        ...
        {
          id: "design-lead-magnet",
          name: "Design a lead magnet",
          description: "Produce a capture-stage product: cover, landing page, email sequence, and conversion target.",
          trigger: "on_instruction",
          steps: [
            "Pick the borrower or introducer magnet from the standing list, or propose a new one against Casey's research",
            "Build the landing page to the hero / recognition / what-you-get / who-built-it / form / absence-proof standard",
            "Write the 5-email sequence: deliver, deepen, situation, absence proof, conversation",
            "Run the quality gate before handing to Shaun",
          ],
          expectedOutput: "Lead-magnet folder with brief, copy, design notes, landing page, and email sequence, all draft",
          x: 280,
          y: 80,
        },
        {
          id: "quarterly-brand-review",
          name: "Run quarterly brand review",
          description: "Audit consistency, recognition, and the competitive field; set next quarter's brand decisions.",
          trigger: "on_instruction",
          steps: [
            "Pull 30 assets from the quarter and score against the quality gate",
            "Read Casey's field intelligence for unprompted mentions and language landing",
            "Run competitive-brief where a competitor has moved",
            "Write three decisions for next quarter, one sentence each",
          ],
          expectedOutput: "brand/quarterly-review.md updated with the audit score, recognition read, and next-quarter decisions",
          escalationRule: "A consistency score under 90% triggers a template fix, flagged to Shaun",
          x: 280,
          y: 240,
        },
      ],
      edges: [
        { id: "e-isla-week-email", source: "queue-week", target: "compose-email-template", label: "same engine" },
        { id: "e-isla-magnet-review", source: "design-lead-magnet", target: "quarterly-brand-review", label: "feeds the audit" },
      ],
    },
  },
  {
    ...
    role: "Head of Market Intelligence (MKT-3)",
    department: "Marketing",
    status: AssociateStatus.AVAILABLE,
    avatar: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&q=80&w=400",
    expertise: [
      "Whole-market UK SME intelligence, 12 domains",
      "Primary-source verification and the stats ledger",
      "Director and introducer voice banks",
      "Competitor and regulatory watch",
      "Creative Ammo Briefs v2",
    ],
    tools: ["Craft Content aid", "Firecrawl", "BrowserOS", "WebSearch / WebFetch", "Companies House API", "The Gazette", "Anthropic", "xAI", "BoE / FCA / ONS / NACFB / BBB / Insolvency Service"],
    description:
      "MKT-3 Head of Market Intelligence. Scans the whole UK SME finance and business-pressure picture — lender conduct, HMRC, insolvency, macro, legal, competitors, director voice — filtered by \"so what for a director\", not product category. Owns the verified-stats ledger and voice banks. Never writes final ad copy. Never invents a number. Never posts.",
    hourlyRate: 0,
    scores: [
      { subject: "Signal quality", A: 95, fullMark: 100 },
      { subject: "Source verification", A: 98, fullMark: 100 },
    ...
    workflow: {
      ...
      responsibilities: [
        "Scan all twelve intelligence domains weekly — lender/broker conduct, HMRC, insolvency, schemes, macro, legal, introducer world, sentiment, competitors, regional",
        "Filter by \"would a director or introducer change what they do, fear, or trust\" — never by product category",
        "Verify every number and named actor against a primary source before it reaches the ledger",
        "Maintain the director and introducer voice banks — verbatim, anonymised, dated, linked",
        "Translate findings into Creative Ammo Briefs for Isla via the \"so what\" ladder — mechanism, not just event",
        "Mark missing figures as MISSING — never invent a number",
        "Run competitor and regulatory watch and keep the gap-analysis list current",
      ...
      tasks: [
        {
          ...
          description: "Full scan across the twelve intelligence domains, logged for the week.",
          trigger: "scheduled",
          steps: [
            "Check the data calendar for releases due and any immediate-pass triggers since last session",
            "Firecrawl and BrowserOS across lender, regulator, press, and forum sources",
            "Filter tangents (consumer credit, mortgages, crypto, payday) and bank PR puffery",
            "Log findings, flag anything needing verification",
          ],
          expectedOutput: "Weekly scan notes covering at least eight of the twelve domains",
          x: 0,
          y: 80,
          shape: "circle",
        },
        {
          id: "verify-and-brief",
          name: "Verify and brief",
          description: "Confirm sources, update the ledger and voice bank, draft Creative Ammo Briefs.",
          trigger: "on_instruction",
          steps: [
            "Two-source minimum for any number or named market actor",
            "Update the verified-stats ledger and add director/introducer voice quotes",
            "Draft up to four Creative Ammo Briefs through the \"so what\" ladder",
            "Run the quality gate — primary source, novelty test, verbatim quote, mechanism, risk flags",
            "Hand off to Isla on /craft — she writes the line",
          ],
          expectedOutput: "Up to four Creative Ammo Briefs ready for Isla, ledger and voice bank current",
          x: 280,
          y: 80,
        },
      ],
      edges: [{ id: "e-casey-scan-brief", source: "scan-week", target: "verify-and-brief", label: "verified into briefs" }],
    },
  },
  {
    id: "media-curator",
  ...
  },
  {
    ...
    name: "Frankie Doyle",
    email: "frankie.doyle@stratanexus.co.uk",
    role: "Social Media Creator (SOCIAL-1)",
    department: "Marketing",
    status: AssociateStatus.AVAILABLE,
    avatar: "https://images.unsplash.com/photo-1519345182560-3f2917c472ef?auto=format&fit=crop&q=80&w=400",
    expertise: [
      "Director psychology and voice",
      "Reply doctrine and comment triage",
      "LinkedIn connection scoring",
      "Compliance-safe content",
    ],
    tools: ["BrowserOS (read-only)", "Firecrawl", "WebSearch/WebFetch", "Trend and reply logs"],
    description:
      "SOCIAL-1. Researches what UK directors are actually saying about commercial finance, drafts LinkedIn/Reddit/Facebook/Instagram content and comment replies, and scores LinkedIn connection candidates. Never publishes, replies, or connects live — Shaun's hands do every write action.",
    hourlyRate: 0,
    scores: [
      { subject: "Brand voice", A: 95, fullMark: 100 },
      { subject: "Compliance discipline", A: 99, fullMark: 100 },
    ],
    voiceEnabled: false,
    aresCertification: { status: "certified", score: 95 },
    workflow: {
      jobDescription: STRATA_SOCIAL_PROMPT,
      responsibilities: [
        "Run a research pass every session and log trend signals before drafting",
        "Draft content across the five pillars (Expose, Translate, Recognise, Equip, Position), never repeating a pillar or hook back to back",
        "Draft replies to comments and DMs using the reply doctrine, triaging distress, hostile, and regulated-territory cases",
        "Score, warm, and draft notes for LinkedIn connection candidates",
        "Never publish, comment, like, follow, connect, or message live on any platform",
      ],
      tasks: [
        {
          id: "research-pass",
          name: "Run research pass",
          description: "Scan platforms and press for director sentiment and trend signals.",
          trigger: "on_instruction",
          steps: [
            "BrowserOS for logged-in reading, Firecrawl for public pages, human pace throughout",
            "Score each finding against the trend criteria",
            "Log verified stats with source and date; drop anything unverifiable",
          ],
          expectedOutput: "Trend log entries ready to brief content drafts",
        },
        {
          id: "draft-content-pack",
          name: "Draft content pack",
          description: "Turn a trend or brief into platform-ready drafts.",
          trigger: "on_instruction",
          steps: [
            "Pick the pillar and platform, avoiding repetition of the last posts",
            "Write hook, recognition, mechanism, turn, close",
            "Run the quality gate before presenting",
          ],
          expectedOutput: "Drafts awaiting Shaun's sign-off, nothing published",
        },
        {
          id: "draft-replies",
          name: "Draft replies",
          description: "Answer comments and DMs per the reply doctrine.",
          trigger: "on_event",
          steps: [
            "Triage: genuine question, DM with a situation, disagreement, hostile, regulated territory, or distress",
            "Draft the reply per doctrine; signpost and flag Shaun on regulated or distressed cases",
          ],
          expectedOutput: "Drafted replies with flags, awaiting Shaun to post",
          escalationRule: "Distressed or hostile commenters are flagged to Shaun the same day",
        },
        {
          id: "score-connections",
          name: "Score connection candidates",
          description: "Identify and score LinkedIn director candidates, draft warm-up and connection notes.",
          trigger: "on_instruction",
          steps: [
            "Score candidates 0-10 against the target profile, discarding automatic exclusions",
            "Draft a warm-up comment and a connection note under 200 characters",
          ],
          expectedOutput: "Scored candidate list with drafted notes; Shaun sends every request by hand",
        },
      ],
    },
  },
